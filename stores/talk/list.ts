...
export const useTalkListStore = defineStore("talkList", {
  ...
  actions: {
    setData({ items, view, isLoading, error, hubUrl }: FetchAllData<Talk>) {
    ...
    updateItem(updatedItem: Talk) {
      const item: Talk | undefined = this.items.find(
